                                        ...
                                        <div class="row mx-0">
                                            <div class="col-md-7 mb-md-0 mb-4 ps-0">
                                                <div class="d-flex svg-illustration align-items-center gap-2 mb-4">
                                                    ...
                                                    <span class="h3 mb-0 app-brand-text fw-semibold text-black">Phenikaa</span>
                                                </div>
                                                <p class="mb-1 text-secondary">Nhà phân phối bia nước ngọt Phenikaa</p>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (status === 200) {
                        ...
                        setTimeout(() => {
                            window.location.href = 'http://localhost:3000/view/pages/admin/lisPhenikaaice.php'
                        },2000)
                    }else {
                        Swal.fire({
                            title: "...Oops!",
