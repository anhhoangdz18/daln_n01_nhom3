...
<head>
  ...
  <title>Chào mừng đến của hàng Phenikaa - Thế giới đồ uống</title>
...
<main>
    <div style="min-height: 86.5vh;">
        ...
        <section class="jumbotron">
          <div class="container">
            <h1 class="display-4">Chào mừng đến với cửa hàng Phenikaa</h1>
        ...
        <section class="py-5">
          <div class="container">
            ...
            <p>Của hàng Phenikaa là một cửa hàng chuyên kinh doanh đồ uống. Chúng tôi cung cấp đa dạng các loại đồ uống, từ đồ uống có cồn đến đồ uống không cồn, từ đồ uống truyền thống đến đồ uống hiện đại.</p>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 col-md-12">
                    <div class="wrapper">
                        <div class="row no-gutters shadow border">
                            <div class="col-md-7 d-flex align-items-stretch">
                                ...
                                <div id="form-message-warning" class="mb-4"></div>
                                    <form method="POST" id="contactForm" name="contactForm" novalidate="novalidate">
                                        ...
                                        <div class="col-md-12">
                                        <div class="form-group">
                                        <input type="text" class="form-control" name="subject" id="subject" placeholder="Vấn đề">
                                        </div>
                                        </div>
                                        <div class="col-md-12">
                                        <div class="form-group">
                            ...
                            <div class="info-wrap bg-primary w-100 p-lg-5 p-4 text-white">
                            <h3 class="mb-4 mt-md-4">Liên lạc với chúng tôi</h3>
                            <div class="dbox w-100 d-flex align-items-start">
                            <div class="icon d-flex align-items-center justify-content-center">
                            <span class="fa fa-map-marker"></span>
                            </div>
                            <div class="text pl-3">
                            <p class="text-white"><span>Địa chỉ:</span> TP Hồ Chí Minh, Việt Nam</p>
                            </div>
                            </div>
                            ...
                            <div class="text pl-3">
                            <p class="text-white"><span>SĐT:</span> <a class="text-white" href="tel://1234567920">+ 1235 2355 98</a></p>
                            </div>
                            </div>
                            <div class="dbox w-100 d-flex align-items-center">
                            <div class="icon d-flex align-items-center justify-content-center">
                            ...
                            <div class="text pl-3">
                            <p><span>Email:</span> <a class="text-white" href="mailto:info@yoursite.com">Phenikaa@gmail.com</a></p>
                            </div>
                            </div>
                            <div class="dbox w-100 d-flex align-items-center">
                            <div class="icon d-flex align-items-center justify-content-center">
                            ...
                            <div class="text pl-3">
                            <p><span>Website</span> <a class="text-white" href="#">Phenikaa.com</a></p>
                            </div>
                            </div>
                            </div>
                            </div>
